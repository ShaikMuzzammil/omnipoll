// lib/types.ts — OmniPoll v2 — All 20 poll types
...
export const POLL_TYPE_META: Record<PollType, {
  icon: string;
  label: string;
  desc: string;
  ...
  multiple_choice: { icon: '📊', label: 'Multiple Choice', desc: 'Real-time vote bars & percentages', plan: 'free', color: 'bg-blue-50 text-blue-600 border-blue-100' },
  word_cloud:      { icon: '☁️', label: 'Word Cloud',      desc: 'Live word aggregation & sizing', plan: 'free', color: 'bg-sky-50 text-sky-600 border-sky-100' },
  qa:              { icon: '❓', label: 'Q&A Session',     desc: 'Upvote the best questions', plan: 'free', color: 'bg-amber-50 text-amber-600 border-amber-100' },
  quiz:            { icon: '🏆', label: 'Live Quiz',       desc: 'Timed scoring & leaderboard', plan: 'free', color: 'bg-yellow-50 text-yellow-600 border-yellow-100' },
  rating:          { icon: '⭐', label: 'Rating Scale',    desc: '1–10 scale with distribution', plan: 'free', color: 'bg-orange-50 text-orange-600 border-orange-100' },
  ranking:         { icon: '🔢', label: 'Ranking',         desc: 'Drag to order options', plan: 'starter', color: 'bg-purple-50 text-purple-600 border-purple-100' },
  open_text:       { icon: '💬', label: 'Open Text',       desc: 'Free-form text responses', plan: 'starter', color: 'bg-teal-50 text-teal-600 border-teal-100' },
  image_choice:    { icon: '🖼️', label: 'Image Choice',    desc: 'Visual poll with images', plan: 'starter', color: 'bg-pink-50 text-pink-600 border-pink-100' },
  nps:             { icon: '📈', label: 'NPS Score',       desc: 'Net Promoter Score 0–10', plan: 'starter', color: 'bg-green-50 text-green-600 border-green-100' },
  matrix:          { icon: '🗃️', label: 'Matrix Grid',     desc: 'Rows × columns rating grid', plan: 'starter', color: 'bg-indigo-50 text-indigo-600 border-indigo-100' },
  slider:          { icon: '🎚️', label: 'Slider',          desc: 'Continuous value selection', plan: 'pro', color: 'bg-violet-50 text-violet-600 border-violet-100' },
  true_false:      { icon: '✅', label: 'True / False',    desc: 'Simple binary choice', plan: 'starter', color: 'bg-emerald-50 text-emerald-600 border-emerald-100' },
  ...
  emoji_reaction:  { icon: '😊', label: 'Emoji Reaction',  desc: 'React with emojis', plan: 'starter', color: 'bg-yellow-50 text-yellow-700 border-yellow-100' },
  ...
  live_matching:   { icon: '🔗', label: 'Live Matching',   desc: 'Match two columns live', plan: 'pro', color: 'bg-fuchsia-50 text-fuchsia-600 border-fuchsia-100' },
};
