      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <motion.div initial={{ opacity:0, y:20 }} animate={{ opacity:1, y:0 }} className="w-full max-w-sm text-center">
          <div className="bg-warm-white dark:bg-card border border-clay/30 rounded-2xl shadow-xl p-8">
            ...
            <h1 className="font-playfair text-2xl font-bold mb-2">Join a poll</h1>
            <p className="text-sm text-muted-foreground mb-6">Enter the 6-character code from your host</p>
            <div className="flex flex-col gap-3">
              <Input
                ...
                className="text-center font-mono tracking-[0.4em] text-xl h-12 uppercase"
                maxLength={6}
                autoFocus
              />
            ...
            <p className="text-xs text-muted-foreground mt-4">No account needed to participate</p>
          </div>
        </motion.div>
      </div>
    </div>
